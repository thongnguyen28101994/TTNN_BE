...
export const updatePassword_Hash = async (req, res) => {
...
export const update_password = async (req, res) => {
    try {
        ...
        const isChaned = await UserApi.changePassword(donviId, userId, oldPassword, newPassword);
        if (isChaned) {
            return res.status(200).json({
...
export const verifyPassword = async (req, res) => {
    try {
        ...
        return res.status(200).json({
            message: "success",
            data: hashPassword_test.verifyPassword(password, "ac4c9c53788e79183ab05a1730e1392a"),
        });
    }
    catch (error) {
        console.error(error);
...
export const themUserBep = async (req, res) => {
    try {
...
export const danhSachBepAn = async (req, res) => {
