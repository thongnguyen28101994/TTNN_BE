...
import { GetDm_DiaChiBoiDuong, getDm_HinhThucDangKy, GetDmHuyen, GetDmTruong, GetThongTinTruong, } from "./controllers/common.controller.js";
import { danhSachBepAn, generateSalt, Login, themUserBep, update_password, updatePassword_Hash, verifyPassword, } from "./controllers/user.controller.js";
import { addAndUpdateFoodCompanyToSchool, addCompanyToSchool, danhSachByIsAuthBySchool, deleteCompanyBySchool, getCompanyBySchoolId, getListCompanySetBySchool, updateIsAuthBySchool, } from "./controllers/school.controller.js";
import { FileServer, createBucket_v2, createFolderFileServer, deleteFileGoogle, 
// downloadFile_v2,
// downloadImage_v2,
getFileGoogle, getListBucket, getListFile_v2, uploadFileImageBase64, uploadFile_v2, uploadMultiFile_congdoan, uploadMultiFile_v2, uploadMultiImage_v2, viewFile_v2, } from "./controllers/file.controller.js";
...
uploadRouter.post("/uploadMultiImage/:schoolId", upload_v2.array("images", 3), uploadMultiImage_v2);
...
// viết tạm schoolId sau này dùng JWT
uploadRouter.post("/uploadMultiFile/:schoolId", upload_v2.array("files", 3), uploadMultiFile_v2);
//upload file cho công đoàn
uploadRouter.post("/uploadMultiFileCongDoan", upload_v2.array("files", 3), uploadMultiFile_congdoan);
